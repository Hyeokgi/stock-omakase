...
def check_warning_market():
    ...
    try:
        # 💡 URL 끝에 현재 시간을 밀리초로 붙여서 무조건 최신 데이터를 받아오도록 강제 (Cache Busting)
...
def analyze_single_stock(name, code, is_warning_market, theme_rank_dict, all_theme_map, kospi_rate):
    ...
    try:
        ...
        if dual_buy_days >= 3 and i_buy_today >= 200_000_000 and f_buy_today >= 200_000_000 and acc_i_buy_eok >= 20:
