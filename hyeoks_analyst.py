...
try:
    ...
    def generate_hyeoks_report(st_type, is_alternative):
        ...
        # 💡 [V7.5] 대안 종목 여부에 따라 5, 6번 지침 자체를 스위칭하여 AI의 긍정 회로 원천 차단
        if is_alternative:
            rule_5 = "5. 프로그램 수급 연계: 제공된 [프로그램] 현황을 분석하여 주가 하방 압력 또는 상승 가능성 냉철하게 서술하십시오."
            rule_6 = "6. 💎 차트 및 수급 딥리딩: 제공된 차트 이미지와 스캐너 데이터를 융합하여 세력의 이탈 또는 시장 소외 현상을 날카롭게 지적하십시오."
            alt_warning = """
...
8. 🚨 팩트 폭격: 수급이 터지지 않았다면 "시장 소외로 인한 가짜 반등 가능성", "방어적 접근 요망" 등 리스크와 한계점을 매섭고 냉철하게 지적하십시오."""
            ...
            rule_5 = "5. 프로그램 수급 연계: 제공된 [프로그램] 현황을 분석하여 주가 상승을 어떻게 뒷받침하는지 서술하십시오."
            rule_6 = "6. 💎 차트 및 수급 딥리딩: 제공된 차트 이미지와 스캐너의 [거래량판독], [프로그램] 비율을 융합하여 세력의 매집 의도를 날카롭게 분석하십시오."
            alt_warning = ""
